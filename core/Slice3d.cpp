...
string Slice3d::getName()
{
  return getLastDirectoryFromPath(inputDir);
  //return getNthDirectoryFromPath(inputDir, 1) + getLastDirectoryFromPath(inputDir);
}
